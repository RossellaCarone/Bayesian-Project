...
y<-growth_vel$f[,1:30] #30 patients
y[69,1]=NA
...
matplot(phi_output[(nburn+1):(niter+nburn),,5],type='l',xlab = 'Iteration', main='phi of patient 5')
...
ylim_plot = c(0,25) #set ylim for the plot
